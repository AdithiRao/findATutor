...
function sendLocation(recipientId) {
  var messageData = {
    ...
    message: {
      text: "Hello, welcome to the FindaTutor bot! To help us find a tutor in your area" + ", please send us your location",
      quick_replies: [
        {
  ...
  var messageData = {
    ...
    message: {
      attachment: {
        ...
        payload: {
          template_type: "button",
          text: "This is test to send location data",
          buttons:[{
            type: "web_url",
